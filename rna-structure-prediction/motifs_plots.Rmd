---
title: "Visualization of RNA structure motifs using radar plots"
...
summary(bpRNA_locrc)
```
```{r, heatmap_structural_elements_6_isoforms, echo=FALSE, fig.width=5.0, fig.height=4.0, dev="pdf", fig.path="figures/", fig.ext="pdf"}
...
```{r, heatmap_structural_elements_EOCRC, echo=FALSE, fig.width=5.0, fig.height=4.0, dev="pdf", fig.path="figures/", fig.ext="pdf"}
...
```{r, heatmap_structural_elements_LOCRC, echo=FALSE, fig.width=5.0, fig.height=4.0, dev="pdf", fig.path="figures/", fig.ext="pdf"}
